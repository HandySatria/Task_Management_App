...
Public Class FormRequest
    ...
    Private Sub GetData()
        Try
            ...
            Call Koneksi()
            Cari_Data = "select r.request_id as request_id, r.request_no as request_no, r.subject as subject, r.description as description, dTo.divisi_name as to_divisi,dTo.divisi_id as to_divisi_id, dFrom.divisi_name as from_divisi, 
            ...
            If Rd.HasRows Then
                ...
                DataGridView1.Columns(9).HeaderText = "User Create"
                DataGridView1.Columns(10).HeaderText = "User Update"
                DataGridView1.Columns(11).HeaderText = "DateTime Create"
                DataGridView1.Columns(12).HeaderText = "DateTime Update"
                DataGridView1.Columns(13).HeaderText = "To Divisi ID"
                DataGridView1.Columns(14).HeaderText = "Id Status"
                ...
                Do While Rd.Read
                    ...
                    DataGridView1(13, baris).Value = Rd.Item("to_divisi_id")
    ...
    Private Sub HapusDataToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles HapusDataToolStripMenuItem.Click
        Select Case MsgBox("Apakah anda yakin ingin menghapus Request " & DataGridView1.CurrentRow.Cells(4).Value & " ?", MsgBoxStyle.YesNo, "MESSAGE")
